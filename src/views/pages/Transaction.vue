<template>
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            ...
            <ion-card>
                <ion-card-content>
                    <ion-input label="Nama Pelanggan" label-placement="floating" placeholder="Masukkan Nama"
                        fill="solid"></ion-input>
                    <ion-input label="Keterangan" label-placement="floating" placeholder="Masukkan Keterangan"
                        fill="solid"></ion-input>
                </ion-card-content>
            </ion-card>
                ...
                <ion-card v-for="(item, index) in cart.stuffs">
                    ...
                    <ion-grid>
                        <ion-row>
                            ...
                            <ion-col>
                                <ion-input v-model="item.count" label="Solid input" label-placement="floating"
                                    fill="solid" placeholder="Enter Text!"></ion-input>
                            </ion-col>
                            <ion-col>
        ...
        <ion-footer>
            <ion-button :disabled="!(cart.stuffs.length > 0 && cart.name != '')" @click="saveTransaction" color="danger"
